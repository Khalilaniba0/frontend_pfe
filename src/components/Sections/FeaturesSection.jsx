...
import PipelineKanbanCard from "components/Sections/PipelineKanbanCard.jsx";
...
import AnalyticsRapportsCard from "components/Sections/AnalyticsRapportsCard.jsx";
import AutomatisationCard from "components/Sections/AutomatisationCard.jsx";

export default function FeaturesSection() {
  return (
    <section id="fonctionnalites" className="th-features-section scroll-mt-28 bg-bg-page py-24 px-8 relative overflow-hidden">
      ...
      <div className="max-w-[1200px] mx-auto relative z-10">
        {/* Header */}
        <div className="th-features-header text-center mb-16">
          ...
          <h2 className="font-body font-extrabold text-4xl text-slate-900 tracking-tight leading-tight mb-4">
          ...
          <p className="font-body text-base text-slate-500 max-w-lg mx-auto leading-relaxed">
