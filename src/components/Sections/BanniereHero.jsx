...
export default function HeroBanner() {
  ...
  return (
    <section className="th-hero-section relative bg-gradient-to-br from-primary-light via-bg-page to-sky-50 min-h-screen flex items-center overflow-hidden pt-24 pb-16 px-4 md:px-0">
      {/* Canvas animé */}
      <canvas
        ref={canvasRef}
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-4 md:px-8 w-full">
        <div className="th-hero-grid grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="th-hero-content flex flex-col gap-7">
            ...
            {/* Title */}
            <h1 className="th-hero-title font-body font-extrabold text-2xl sm:text-4xl lg:text-[3.5rem] leading-[1.1] text-slate-900 tracking-tight">
              Le recrutement,{" "}
              <span className="bg-gradient-to-r from-primary to-primary-dark bg-clip-text text-transparent">
               Recrutez 2x plus vite, sans friction.
              </span>
              <span className="block text-slate-400 font-normal text-lg sm:text-2xl mt-2 tracking-normal">
                Talentia ATS — pensé pour aller vite.
              </span>
            </h1>

            {/* Subtitle */}
            <p className="th-hero-subtitle font-body text-base sm:text-lg text-slate-500 leading-relaxed max-w-lg">
